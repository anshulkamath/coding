...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if (plist) {
        ...
        // There is no dataset; create a empty array
        self.tasks = [NSMutableArray array];
    }
    
    // Create and configure the UIWindow instance
    // A CGRect is a struct with an origin of (x, y) and a size (width, height)
    ...
    CGRect fieldFrame = CGRectMake(0, 40, 200, 31);
...
#pragma mark - Table view assignment
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // ... and hand the properly configured cell to the table view
    return c;
}
