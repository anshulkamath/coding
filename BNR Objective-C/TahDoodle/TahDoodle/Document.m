...
- (id)tableView:(NSTableView *)tableView
    objectValueForTableColumn:(NSTableColumn *)tableColumn
            row:(NSInteger)row
{
    // Return the item from the tasks that corresponds to the cell
...
- (NSData *)dataOfType:(NSString *)typeName error:(NSError **)outError {
    ...
    // You are expected to hand the caller an NSData object wrapping out data
    // so that it can be written to the disk
...
- (BOOL)readFromData:(NSData *)data ofType:(NSString *)typeName error:(NSError **)outError {
    ...
    // This document is called when a method is being loaded
    ...
    // Return success or failure depending on success of above call
...
- (void)addTask:(id)sender
{
    ...
    // (which happens to be the BNRDocument object in this case)
